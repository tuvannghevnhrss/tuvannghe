export const QUESTIONS = [
  ...
  { id: 4, question: "Khi tham gia lớp mới", options: ["Bạn bắt chuyện với mọi người", "Bạn chờ người khác tới hỏi"], pair: ["E", "I"] },
  { id: 5, question: "Bạn thích cuối tuần", options: ["Đi phượt cùng nhóm đông", "Thư giãn một mình ở nhà"], pair: ["E", "I"] },
  { id: 6, question: "Trả lời tin nhắn", options: ["Ngay lập tức, thích trao đổi", "Khi thấy cần, thích ngắn gọn"], pair: ["E", "I"] },
  ...
  { id: 11, question: "Khi gọi video", options: ["Bạn thấy hào hứng", "Bạn thấy tiêu hao năng lượng"], pair: ["E", "I"] },
  { id: 12, question: "Ở tiệc sinh nhật", options: ["Bạn kể chuyện, khuấy động", "Bạn ngồi nghe, mỉm cười"], pair: ["E", "I"] },
  ...
  { id: 15, question: "Trong lớp học", options: ["Bạn giơ tay phát biểu", "Bạn ghi chú lặng lẽ"], pair: ["E", "I"] },
  ...
  { id: 19, question: "Trong cuộc họp bạn tập trung", options: ["Chi tiết cụ thể", "Tầm nhìn dài hạn"], pair: ["S", "N"] },
  ...
  { id: 23, question: "Khi giải quyết vấn đề", options: ["Theo từng bước", "Nhảy vọt tìm giải pháp"], pair: ["S", "N"] },
  { id: 24, question: "Bạn nhận xét người khác qua", options: ["Những gì họ làm", "Khả năng tiềm tàng"], pair: ["S", "N"] },
  ...
  { id: 27, question: "Bạn tin", options: ["Kinh nghiệm quá khứ", "Khả năng tương lai"], pair: ["S", "N"] },
  ...
  { id: 30, question: "Bạn chọn mua đồ", options: ["Dùng thử thực tế", "Xem concept trước"], pair: ["S", "N"] },
  ...
  { id: 34, question: "Trong tranh luận", options: ["Tập trung logic", "Quan tâm cảm xúc"], pair: ["T", "F"] },
  ...
  { id: 44, question: "Bạn coi trọng", options: ["Sự thật", "Lòng trắc ẩn"], pair: ["T", "F"] },
