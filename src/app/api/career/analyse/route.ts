...
export const runtime  = 'nodejs';         // để dùng Service-Role key nếu cần

export async function POST () {
  /* 1. Lấy session & user -------------------------------------------------- */
  const supabase = createSupabaseRouteServerClient();   // <-- KHÔNG truyền cookies
  ...
  /* 3. Đã có phân tích? -> trả cached để tiết kiệm token ------------------ */
